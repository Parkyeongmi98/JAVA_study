...
//        String name = sc.next();  // 입력을 하고 나면 다음으로 넘어감
//        System.out.println("혈액형을 입력하세요.");
//        String bloodType = sc.next();
//        System.out.println("키를 입력하세요.");
//        //int height = Integer.parseInt(sc.next());  // sc.next는 String이므로 int로 형변환
...
//        System.out.println("몸무게: " + weight);
        ...
        //String lang = sc.next();  // 한 단어(자바 파이썬)  -> sc.next는 띄어쓰기로 구분해서 한 단어만 출력하고 넘어감
        String lang = sc.nextLine();  // 띄어쓰기가 아닌 한 줄로 구분
